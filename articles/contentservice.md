...
The ContentService acts as a "gateway" to Umbraco data for operations which are related to Content. Read more on the API docs for the [ContentService](xref:Umbraco.Core.Services.Implement.ContentService).
